...
\begin{figure}[ht]
    \begin{center}
        \subfigure[AR Activity]{\includegraphics[width=0.3\textwidth]{img/App_screenshots/AR-mode.jpg}}
        \hspace{0.2cm} % Adjust the horizontal spacing between the images
        \subfigure[QR Activity]{\includegraphics[width=0.3\textwidth]{img/App_screenshots/Scan-QR.jpg}}
        \hspace{0.2cm} % Adjust the horizontal spacing between the images
...
\begin{figure}[ht]
    \begin{center}
        ...
        \hspace{2cm} % Adjust the horizontal spacing between the images
        \subfigure[Scanning QR code]{\includegraphics[width=0.4\textwidth]{img/App_screenshots/Scan-QR.jpg}}
